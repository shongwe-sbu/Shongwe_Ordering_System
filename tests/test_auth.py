...
class AuthenticationTests(unittest.TestCase):
    def setUp(self):
        clear_users()
        register_user("admin1", "admin12345", ADMIN_ROLE)
        register_user("emp1", "emp12345", EMPLOYEE_ROLE)

    def test_admin_login_authenticates_successfully(self):
        user = authenticate("admin1", "admin12345")
    ...
    def test_employee_login_authenticates_successfully(self):
        user = authenticate("emp1", "emp12345")
        self.assertIsNotNone(user)
    ...
    def test_role_mismatch_is_rejected(self):
        user = authenticate("emp1", "emp12345", ADMIN_ROLE)
        self.assertIsNone(user)
